(function ($) {
  ...
  */
  ...
  --------------------------------------------------------------*/
  if (document.querySelector(".services-list") !== null) {
    const buttons = document.querySelectorAll(".btn-services");
    const contents = document.querySelectorAll(".services-list");
    ...
    buttons.forEach((button, i) => {
      button.addEventListener("click", () => showContent(i));
    });
  }
  if (document.querySelector(".mySwiper-about-us") !== null) {
    var swiper = new Swiper(".mySwiper-about-us", {
      effect: "fade",
      autoHeight: true,
      navigation: {
      ...
      $("#contact-form #submit").on("click", function () {
        ...
        if (!regex.test(email)) {
          $("#st-alert")
            .fadeIn()
            .html(
              '<div class="alert alert-danger"><strong>Warnung!</strong> Bitte verwende eine gültige E-Mail.</div>'
            );
          return false;
        }
        ...
        if (name != "" && email != "" && msg != "") {
          ...
          $.ajax({
            ...
            success: function () {
              ...
              $("#st-alert")
                .fadeIn()
                .html(
                  '<div class="alert alert-success"><strong>Erfolgreich!</strong> Deine Terminanfrage wurde erfolgreich versendet.</div>'
                );
              setTimeout(function () {
          ...
          $("#st-alert")
            .fadeIn()
            .html(
              '<div class="alert alert-danger"><strong>Warnung!</strong> Alle Felder müssen ausgefüllt werden.</div>'
            );
        }
        return false;
      });
